...
public:
	...
	virtual CoreMapper::MapCost Core_tensor_explore(const Layer& layer, const tensor_shape& tensor, bool wgtB) = 0;
	virtual CoreMapper::CoreMapping Core_tensor_explore_full(const Layer&layer, const tensor_shape& tensor, bool wgtB) = 0;
};
...
public:
	...
	virtual CoreMapper::MapCost Core_tensor_explore(const Layer& layer, const tensor_shape& tensor, bool wgtB);
	virtual CoreMapper::CoreMapping Core_tensor_explore_full(const Layer&layer, const tensor_shape& tensor, bool wgtB);
};
