...
public:
	...
	// pos2idx(pos) == k means taht pos is between kth 1 and k+1th 1.
	// if pos <= 1st 1, pos2idx(pos) == 0. if pos > last 1, pos2idx(pos) == count().
	bitlen_t pos2idx(bitlen_t bit)const;
	...
	std_bs::reference operator[](const bitlen_t bit);
