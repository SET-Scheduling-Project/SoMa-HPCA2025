...
static Network genNAS(const Genotype& geno, len_t C, len_t nClasses, unsigned nCells, bool no_fc=false){
	Network::lid_t prev;
	Network n;
	len_t H_prev, H_in;
	H_in = 331;
...
const Network PNASNet_no_fc = genNAS(PNASNet_geno, 216, 1001, 12, true);
